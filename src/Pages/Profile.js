...
function Profile() {
    ...
    const handleImageUpload = async (e) => {
        ...
        formData.append('upload_preset', 'bu7vmcxi');
        formData.append('cloud_name', 'dnzljxgou');

        let response = await axios.post('https://api.cloudinary.com/v1_1/dnzljxgou/image/upload', formData);
